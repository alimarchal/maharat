...
import { faArrowLeftLong, faChevronRight, faEye, faCheck, faEdit, faTrash } from "@fortawesome/free-solid-svg-icons";
        ...
        <AuthenticatedLayout user={auth.user}>
            <div className="min-h-screen p-6">
                ...
                <div className="flex items-center text-[#7D8086] text-lg font-medium space-x-2 mb-6">
                    ...
                    <FontAwesomeIcon icon={faChevronRight} className="text-xl text-[#9B9DA2]" />
                    <span className="text-[#009FDC] text-xl">Report Logs</span>
                </div>

                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-[32px] font-bold text-[#2C323C] whitespace-nowrap">Report Logs</h2>
