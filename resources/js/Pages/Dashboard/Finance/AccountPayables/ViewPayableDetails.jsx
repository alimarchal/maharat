...
const ViewPayableDetails = () => {
    const { payableId } = usePage().props;
        ...
        const fetchAccountDetails = async () => {
            ...
            try {
                ...
                const [accountResponse, flowsResponse] =
                    await Promise.all([
                        axios.get(`/api/v1/accounts/${payableId}`),
                        axios.get(`/api/v1/accounts/${payableId}/transaction-flows`),
                    ]);
...
export default ViewPayableDetails;
