...
const BudgetReallocationStatusFlow = () => {
    ...
    const [reallocationDate, setReallocationDate] = useState(null);
    ...
    const fetchStatus = async (id) => {
        try {
            ...
            if (response.data?.data?.[0]?.request_budget?.created_at) {
                setReallocationDate(response.data.data[0].request_budget.created_at);
            }
                ...
                <div className="p-4 border-b border-gray-300">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="text-gray-500 text-sm">
                            {reallocationDate ? (
                                <>
                                    {new Date(reallocationDate).toLocaleDateString("en-US", {
                                        day: "2-digit",
                                        month: "short",
                                        year: "numeric",
                                    })}{" "}
                                    <span className="text-xs text-gray-400">
                                        {new Date(reallocationDate).toLocaleTimeString("en-US", {
                                            hour: "2-digit",
                                            minute: "2-digit",
                                            hour12: true,
                                        })}
                    ...
                    <>
                        ...
                        {cardsToShow.length > 0 ? (
                            ...
                            <div className="p-4 text-center text-gray-500 text-base">
                                No Budget Reallocation Approval transactions available.
                            </div>
                        )}
                    </>
                ) : (
...
export default BudgetReallocationStatusFlow;
