    ...
    return (
        <div className="flex flex-col items-center justify-center space-y-2">
            ...
            <span
                ...
                onClick={() => fileUrl && window.open(fileUrl, "_blank")}
            >
                {typeof file === "object" && file.original_name
                    ? file.original_name
                    : "View Attachment"}
            </span>
        </div>
        ...
        try {
            ...
            if (!hasExistingOrders) {
                const newPurchaseOrder = {
                    ...
                    status: "Draft",
                    company_name:
                        quotationResponse.data.data.company_name || "",
                    quotation_number:
                        quotationResponse.data.data.quotation_number,
                    attachment: null,
                    original_name: null,
                };
                ...
                <div className="w-full overflow-hidden">
                    ...
                    {quotationDetails && (
                        <p className="text-purple-600 text-2xl mb-6">
                            Quotation# {quotationDetails.quotation_number}
                        </p>
                    )}
