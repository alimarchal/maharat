const SelectFloating = ({ label, name, value, onChange, options }) => {
    return (
        <div className="relative w-full">
            ...
            <label
                className={`absolute left-3 px-2 bg-white text-gray-500 text-sm transition-all 
                peer-focus:top-0 peer-focus:text-xs peer-focus:text-[#009FDC] 
                peer-focus:px-2 -translate-y-1/2 ${
                    value
