...
export const PERMISSIONS = {
    ...
    VIEW_MATERIAL_REQUEST_STATUS: 'view_material_request_status',
    VIEW_RFQ_STATUS: 'view_rfq_status',
    VIEW_PURCHASE_ORDER_STATUS: 'view_purchase_order_status',
    VIEW_PAYMENT_ORDER_STATUS: 'view_payment_order_status',
    VIEW_INVOICE_STATUS: 'view_maharat_invoice_status',
    VIEW_BUDGET_REQUEST_STATUS: 'view_budget_request_status',
    VIEW_BUDGET_REALLOCATION: 'view_budget_reallocation',
    VIEW_BUDGET_REALLOCATION_STATUS: 'view_budget_reallocation_status',
    TOTAL_BUDGET_REQUEST: 'view_total_budget_status',
    VIEW_SHORT_DELIVERY_STATUS: 'view_short_delivery_status',
};
...
export const PERMISSION_GROUPS = {
    ...
    STATUSES: [PERMISSIONS.STATUSES, PERMISSIONS.VIEW_MATERIAL_REQUEST_STATUS, PERMISSIONS.VIEW_RFQ_STATUS, PERMISSIONS.VIEW_PURCHASE_ORDER_STATUS, PERMISSIONS.VIEW_PAYMENT_ORDER_STATUS, PERMISSIONS.VIEW_INVOICE_STATUS, PERMISSIONS.VIEW_BUDGET_REQUEST_STATUS, PERMISSIONS.VIEW_BUDGET_REALLOCATION_STATUS, PERMISSIONS.TOTAL_BUDGET_REQUEST, PERMISSIONS.VIEW_SHORT_DELIVERY_STATUS],
