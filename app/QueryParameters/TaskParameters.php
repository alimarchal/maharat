...
class TaskParameters
{
    ...
    const ALLOWED_INCLUDES = [
        ...
        'purchase_order.user',
        'purchase_order.subCostCenter',
        'purchase_order.alternativeSubCostCenter',
        'purchase_order.reallocationRequest',
        'purchase_order.reallocationRequest.updatedDestinationSubCostCenter',
        'purchase_order.reallocationRequest.reallocateToSubCostCenter',
        'payment_order',
        'payment_order.supplier',
        'payment_order.user',
        'payment_order.purchase_order',
        'invoice',
        'invoice.items',
        'invoice.client',
        ...
        'request_budget.subCostCenter',
        'request_budget.reallocateToSubCostCenter',
        'request_budget.originalDestinationSubCostCenter',
        'request_budget.updatedDestinationSubCostCenter',
