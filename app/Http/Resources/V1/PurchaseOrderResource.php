...
class PurchaseOrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'alternative_sub_cost_center_id' => $this->alternative_sub_cost_center_id,
            'alternative_budget_amount' => $this->alternative_budget_amount,
            ...
            'alternative_request_budget_id' => $this->alternative_request_budget_id,
...
//            // Include related resources when loaded
            ...
            'alternativeSubCostCenter' => new CostCenterResource($this->whenLoaded('alternativeSubCostCenter')),
            ...
            'alternativeRequestBudget' => new RequestBudgetResource($this->whenLoaded('alternativeRequestBudget')),
